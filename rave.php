...
//                         v 2.0.34                            //
//                                                             //
//           by Mike Gieson <info@wimpyplayer.net>             //
...
$media_types = "mov,flv,mpv,mpg,m4v,m4p,mpg4,mp4,mpeg,mp4,3gp,m4a,m4a,m4p,aac,mp3,swf,xml,m3u,pls";
...
if(@ini_get('safe_mode')){
	...
	print('	Wimpy from performing <br>');
...
function makeXMLplaylist($theDir, $recursive=false){
	global $WIMPY_PATH, $wimpyApp, $defaultVisualBaseName, $defaultVisualExt, $Amedia_types;
